...
@Component({
  selector: 'dg-test-blog-posts',
  templateUrl: './test-blog-posts.component.html',
  styleUrls: ['./test-blog-posts.component.css']
})
export class TestBlogPostsComponent implements OnInit {
